...
if (!class_exists('WPTrait\Model')) {
    ...
    class Model
    {
        ...
        public $db, $wp, $query, $plugin, $pagenow, $admin_bar, $screen, $post, $term, $attachment, $user, $option, $request,
        ...
        {
            global $wpdb, $wp, $wp_query, $pagenow, $wp_admin_bar, $current_screen;
